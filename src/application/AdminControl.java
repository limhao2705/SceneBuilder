...
public class AdminControl implements Initializable{
    ...
    public void switchScene(ActionEvent event){
    	if(event.getSource() == dashboard_btn) {
    		...
    		dashboard_btn.setStyle("-fx-background-color: transparent");
    		order_btn.setStyle("-fx-background-color: transparent");
    		addMed_btn.setStyle("-fx-background-color: #d7dbd8");    		
    		report_btn.setStyle("-fx-background-color: transparent");
    		login_btn.setStyle("-fx-background-color: transparent");
